...
# -------------------------------------------------------------------------
const _nauxstate = 3
const _a_x, _a_y, _a_z, _a_l, _a_i = 1:_nauxstate
@inline function auxiliary_state_initialization!(aux, x, y, z)
    @inbounds begin
        ...
        #Store q_liq and q_ice for plotting purposes
        xvert        = y
...
function run(mpicomm, dim, Ne, N, timeend, DFloat, dt)
    ...
    topl = BrickTopology(mpicomm, brickrange, periodicity=(true,false,true))
